...
from models import resnet, resnet2p1d, pre_act_resnet, wide_resnet, resnext, densenet, ConvNext3D
...
def generate_model(opt):
    assert opt.model in [
        'resnet', 'resnet2p1d', 'preresnet', 'wideresnet', 'resnext', 'densenet', 'ConvNext3D'
    ]
